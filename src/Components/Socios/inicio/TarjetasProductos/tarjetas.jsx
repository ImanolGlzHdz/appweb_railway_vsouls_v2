  ...
  const [user,setUser]=useState();
    ...
    const [fav, setFav]=useState([]);
        ...
        const getProds = () => {
          ...
          if (idUsuarioGlobal) {
          fetch(`${import.meta.env.VITE_API}/favoritos/cli/${idUsuarioGlobal}`)
            .then((res) => {
              if (!res.ok) {
    ...
    const insertFav = (prod) => {
      ...
      fetch(`${import.meta.env.VITE_API}/new/fav/socios`, requestInit)
        .then((res) => res.text())
        .then((res) => {
          console.log(res);
    ...
    const handleDelete = (prod) => {
      ...
      fetch(`${import.meta.env.VITE_API}/delete/fav/socios`, requestInit)
        .then((res) => res.text())
        .then((res) => {
          console.log(res);
    ...
    useEffect(() => {
        ...
        // console.log(user)
        const getProds = () => {
          fetch(`${import.meta.env.VITE_API}/productosActivos`)
          .then(res => res.json())
