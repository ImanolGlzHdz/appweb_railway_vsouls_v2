...
const Tarjetas = () => {
  ...
  const cargarProductos = async () => {
    try {
      const respuesta = await fetch("https://apivsoulsapi8-production.up.railway.app/productos");
  ...
  const agregarpaquetesalcarrito = async (idProducto) => {
    ...
    try {
      ...
      const response = await fetch(`https://apivsoulsapi8-production.up.railway.app/carrito/paquetes/${idUsuarioGlobal}/${idProducto}`, {
        method: 'POST',
      });
      // alert(`https://apivsoulsapi8-production.up.railway.app/carrito/paquetes/${idUsuarioGlobal}/${idProducto}`)
