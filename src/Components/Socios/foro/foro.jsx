...
const Foro = () => {
  ...
  const fetchMensajes = () => {
    ...
    if (idUsuarioGlobal) {
      fetch(`https://apivsoulsapi8-production.up.railway.app/mensajes/${idUsuarioGlobal}`)
  ...
  const enviarMensaje = async () => {
    try {
      const response = await fetch('https://apivsoulsapi8-production.up.railway.app/mensajes', {
        method: 'POST',
        headers: {
