            ...
            <div className='wrapperDp' key={producto.CLAVE_P}>
                <div className='wrapperI'>
                    <div className='image-wrapper'>
                        <img className='imgContent' src={'https://apivsoulsapi8-production.up.railway.app/products/'+ producto.CLAVE_P + '-IMG_PRINCIPAL.png'} alt="" />
                        <img className='imgContent' src={'https://apivsoulsapi8-production.up.railway.app/products/'+ producto.CLAVE_P + '-IMG1.png'} alt="" />
                        <img className='imgContent' src={'https://apivsoulsapi8-production.up.railway.app/products/'+ producto.CLAVE_P + '-IMG2.png'} alt="" />
                        <img className='imgContent' src={'https://apivsoulsapi8-production.up.railway.app/products/'+ producto.CLAVE_P + '-IMG3.png'} alt="" />
                    </div>
