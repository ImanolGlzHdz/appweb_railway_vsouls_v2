...
// console.log(startDate, endDate)
    ...
    fetch(`https://apivsoulsapi8-production.up.railway.app/ventas/${startDate}/${endDate}`)
      .then(response => response.json())
      .then(data => {
      console.log(`https://apivsoulsapi8-production.up.railway.app/ventas/${formattedDate2}/${formattedDate2}`)
