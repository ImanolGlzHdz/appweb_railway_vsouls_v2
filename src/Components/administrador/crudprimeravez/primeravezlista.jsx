...
const cargarprimeravez = () =>{
  ...
  fetch("https://apivsoulsapi8-production.up.railway.app/primeravez")
  ...
  const handleEliminar = (id) => {
    ...
    fetch(`https://apivsoulsapi8-production.up.railway.app/primeravez/eliminar/${id}`, {
      method: 'DELETE',
    })
      .then(response => response.json())
      .then(data => {
  ...
  const handleActualizarPrecio = () => {
    ...
    fetch(`https://apivsoulsapi8-production.up.railway.app/primeravez/editar/${productoSeleccionado}/${nuevoPrecio}`, {
