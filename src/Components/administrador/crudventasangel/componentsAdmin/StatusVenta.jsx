...
const StatusVenta = () => {
    ...
    const getHistorial = async () => {
        try {
            const response = await axios.get(`${import.meta.env.VITE_API}/ver-status-venta/${anioSeleccionado}`);
    ...
    const handleGuardarGuia = async () => {
        try {
            ...
            await axios.put(`${import.meta.env.VITE_API}/agregar-guia-venta/${ventaId}/${guiaVenta}`);
            setShowModal(false);
            getHistorial();
          } catch (error) {
