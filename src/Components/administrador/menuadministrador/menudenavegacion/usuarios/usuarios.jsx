...
<div className='menudepublidad moveratras activonuevo'>
     ...
     <Link to='/admin/usuarios/registro' class='amenu logo activonuevo moveratras'>Agregar </Link>
            <Link to='/admin/usuarios' class='amenu logo activonuevo moveratras'> Registros</Link>
