      ...
      <div className="todomenuadmi bodyadmi moveratras">
        ...
        <ul className="menu-links">
            ...
            <div className='menudepublidad moveratras activonuevo'>
                <Link to='/menupublicidadAgregar' className='tamanioletratitulo activonuevo moveratras'>Agregar</Link>
                <Link to='/menupublicidadLista' className=' tamanioletratitulo activonuevo moveratras'>Imagenes</Link>
            </div>
            <a className="amenu logo" href='#'>
              <h3 href='#'>Vsouls</h3>
            </a>
          </nav>
        </header>
