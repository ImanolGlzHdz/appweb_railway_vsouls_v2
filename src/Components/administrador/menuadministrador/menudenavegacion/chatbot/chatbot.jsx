...
<Link to='/admin/chatbot' class='amenu logo activonuevo moveratras'>Agregar </Link>
       <Link to='/admin/chatbot/lista' class='amenu logo activonuevo moveratras'> Registros</Link>
