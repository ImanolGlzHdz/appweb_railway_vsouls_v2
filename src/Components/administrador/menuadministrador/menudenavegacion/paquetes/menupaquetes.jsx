    ...
    <>
      <div className="todomenuadmi bodyadmi moveratras">
        ...
        <span id="hamburger-btn" className="spanadmi material-symbols-outlined">Menu</span>
            ...
            <div className='menudepublidad'>
                <Link to='/menupaquetesinicio' className='activonuevo moveratras'>Agregar</Link>
                <Link to='/menupaqueteslista' className='activonuevo moveratras'>Paquetes</Link>
            </div>
