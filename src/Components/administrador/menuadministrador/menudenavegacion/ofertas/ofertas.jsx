...
<Link to='/admin/ofertas' class='amenu logo activonuevo moveratras'>Agregar </Link>
       <Link to='/admin/ofertas/lista' class='amenu logo activonuevo moveratras'> Registros</Link>
