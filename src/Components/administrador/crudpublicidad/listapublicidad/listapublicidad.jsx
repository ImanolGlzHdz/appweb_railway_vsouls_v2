...
const Listapublicidad = () => {
  ...
  const funcionEliminar = (id) => {
    ...
    fetch(`${import.meta.env.VITE_API}/publicidad/delete/${id}`, {
            ...
            <tbody className='moveratras'>
              {Publicidad.map(publicidad => (
                <tr key={publicidad}>
                  ...
                  <td className='moveratras'><img className='tamanioimagen2 moveratras' src={`${import.meta.env.VITE_API}/publicidad/` + publicidad} alt='...'></img></td>
