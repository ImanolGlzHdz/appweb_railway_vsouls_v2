...
const EditarPaquetes = () => {
  ...
  const eliminarProductoDelPaquete = (idProducto, idPaquete_p) => {
    ...
    const url = `https://apivsoulsapi8-production.up.railway.app/paquetes/productos/${idProducto}/${idPaquete_p}`;
  ...
  const cargarProductosporPaquete = () => {
    ...
    fetch(`https://apivsoulsapi8-production.up.railway.app/paquetes/productos/${id_paquete_producto}`)
      .then(respuesta => respuesta.json())
      .then(data => {
