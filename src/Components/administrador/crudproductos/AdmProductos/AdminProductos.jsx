...
const AdminProductos = () => {
  ...
  useEffect(() => {
    const getProds = () => {
      fetch('https://apivsoulsapi8-production.up.railway.app/products')
      .then(res => res.json())
  ...
  useEffect(()=>{
    fetch('https://apivsoulsapi8-production.up.railway.app/imagesI')
      .then(res => res.json())
  ...
  const searchChange = (e)=>{
    ...
    if(text==""){
      ...
      console.log(text);
      const getProds = () => {
        fetch('https://apivsoulsapi8-production.up.railway.app/productos/buscador/'+ text )
        .then(res => res.json())
        .then(res => setProductos(res))
      }
      getProds()
  ...
  const sendHandler = () => {
    ...
    fetch('https://apivsoulsapi8-production.up.railway.app/create/product', {
      method: 'POST',
      body: formdata
    })
    .then(res => res.text())
  ...
  const actualizar = () =>{
    ...
    fetch('https://apivsoulsapi8-production.up.railway.app/update/productos/' + CLAVE_P, requestInit)
    .then(res => res.text())
  ...
  const handleFileChange = (e) => {
    ...
    if (selectedFile) {
      ...
      fetch('https://apivsoulsapi8-production.up.railway.app/actualizarI/'+ CLAVE_P, {
        method: 'PUT',
        body: formdata
      })
      .then(res => res.text())
      ...
      <div className='containerAdmin limitetabla moveratras'>
        ...
        <div className='wrapperAdminP moveratras'>
            ...
            <div className="cardAdmin" key={prod.CLAVE_P}>
              <img className="cardImgA" src={'https://apivsoulsapi8-production.up.railway.app/products/'+ prod.CLAVE_P + '-IMG_PRINCIPAL.png'}  alt="productos" />
      ...
      <Modal className='modalPr' isOpen={modalEditarImg}>
        ...
        <div className='imagenesA'>
            <table className="table table-striped">
              ...
              <tr key={img.id}>
                <td>{img.titulo}</td>
                <td><img src={'https://apivsoulsapi8-production.up.railway.app/products/'+ productSelect.CLAVE_P + '-'+ img.tipoI+'.png'}  alt="productos" /></td>
