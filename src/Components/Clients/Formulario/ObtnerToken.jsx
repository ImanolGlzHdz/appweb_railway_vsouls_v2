...
export const ObtenerToken = () => {
    ...
    const handleSubmit = () => {
        ...
        fetch('https://apivsoulsapi8-production.up.railway.app/token', requestInit)
        .then(res => res.json())
        .then(res => {
        ...
        fetch('https://apivsoulsapi8-production.up.railway.app/correo/enviar-correo', requestInit1)
        .then(res => res.text())
        .then(res => {
