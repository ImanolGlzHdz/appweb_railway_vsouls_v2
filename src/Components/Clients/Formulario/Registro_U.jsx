...
export const Registro_U = () => {
    ...
    const handleChange = e => {
      ...
      const { name, value } = e.target;
        ...
        fetch('https://apivsoulsapi8-production.up.railway.app/cliente/post', requestInit)
        .then(res => res.json())
        .then(res => {
    ...
    if ( parseInt(correo, 10) >= 1) {
      ...
      return
        ...
        fetch('https://apivsoulsapi8-production.up.railway.app/api/insertarUsuario', requestInit)
        .then(res => res.json())
        .then(res => {
