...
export const ActuPerfil = () => {
    ...
    const handleUpdate= () => {
        ...
        fetch('https://apivsoulsapi8-production.up.railway.app/cliente/put', requestInit)
        .then(res => res.text())
        .then(res => {
            setPerfilU(res);
    ...
    // ----------------------- SUBIR IMAGEN -----------------------------
        ...
        fetch(`https://apivsoulsapi8-production.up.railway.app/imgCliente/upload/${userId}`, {
        method: 'POST',
        body: formData,
        })
        .then((res) => res.json())
                  ...
                  {currentImage ? (
                    ...
                    <div className='circle-image'>
                      <img
                        ...
                        src={`https://apivsoulsapi8-production.up.railway.app/${currentImage}`}
                        alt="..."
                      />
                    </div>
                  ) : (
