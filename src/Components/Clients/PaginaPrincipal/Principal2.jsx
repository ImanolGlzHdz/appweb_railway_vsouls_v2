...
export const Principal2 = ({ id }) => {
    ...
    useEffect(() => {
        const getCarrucel = () => {
            fetch('https://apivsoulsapi8-production.up.railway.app/carrucel/get')
                .then(res => res.json())
                .then(data => {
                    setImageList(data);
                })
    ...
    useEffect(() => {
        const getOfertas = () => {
            fetch('https://apivsoulsapi8-production.up.railway.app/ofertasNew')
                .then(res => res.json())
                .then(data => {
                    setOfertas(data);
                })
    ...
    return (
        <>
                    ...
                    <div class="carousel-inner">
                        {imageList.map((image, index) => (
                            <div key={index} className={`carousel-item ${index === 0 ? 'active' : ''}`}>
                                <img
                                    src={`https://apivsoulsapi8-production.up.railway.app/dbimages/${image}`}
                                    alt="..."
            ...
            <section class="u-clearfix u-section-1" id="sec-beab">
                <div class="">
            ...
            <section class="u-clearfix u-gradient u-section-3" id="carousel_421b">
                                    ...
                                    <div class="u-container-layout u-container-layout-1">
                                        ...
                                        <div class="custom-expanded u-border-2 u-border-grey-75 u-container-style u-group u-radius u-shape-round u-group-1">
                                            <div class="u-container-layout u-container-layout-2"><span class="u-custom-color-1 u-icon u-icon-circle u-text-white u-icon-1">
                                                ...
                                                <svg class="u-svg-content" viewBox="0 0 54.757 54.757" x="0px" y="0px" id="svg-e83a" style={{ enableBackground: 'new 0 0 54.757 54.757' }}><g><path d="M27.557,12c-3.859,0-7,3.141-7,7s3.141,7,7,7s7-3.141,7-7S31.416,12,27.557,12z M27.557,24c-2.757,0-5-2.243-5-5
		...
		C45.576,13.08,46.321,24.468,41.099,31.431z"></path>
                                                ...
                                                <h5 class="u-text u-text-2"> C. Isidro Huarte 53, Centro histórico de Morelia, 58000 Morelia, Mich.</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section class="u-clearfix u-section-4" id="sec-65a4">
                <div class="u-clearfix u-sheet u-sheet-1">
                    <h3 class="u-text u-text-default u-text-1">Nuestras Mejores Ofertas</h3>
                    <div class="u-container-style u-group u-group-1">
                        <div class="u-container-layout u-container-layout-1">
                            <div class='contC'>
                                <div class='wrapperCatalogo'>
                                    {ofertas.map(oferta => (
                                        <div class='card' key={oferta.ID_OFERTA}>
                                            <a style={{ textDecoration: "none" }} onClick={() => seleccionarProducto(oferta)}>
                                                <div class='linkOferta'>
                                                    <h2>En Oferta</h2>
                                                </div>
                                                <div class='img-box'>
                                                    <img src={'https://apivsoulsapi8-production.up.railway.app/products/' + oferta.CLAVE_P + '-IMG_PRINCIPAL.png'} alt="" />
                                                </div>
                                            </a>
                                            <div class='details'>
