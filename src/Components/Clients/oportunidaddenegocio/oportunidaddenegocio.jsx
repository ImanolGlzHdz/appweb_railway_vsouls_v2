...
// alert(`https://apivsoulsapi8-production.up.railway.app/usuario/new/subsocio/${formData.CORREO}/${formData.PASSWORD}/${codigoInvitacion}`)
  // Construir la URL para la solicitud POST
  const apiUrl = `https://apivsoulsapi8-production.up.railway.app/usuario/new/subsocio/${formData.CORREO}/${formData.PASSWORD}/${codigoInvitacion}`;
