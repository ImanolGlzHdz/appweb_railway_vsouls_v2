...
const DetalleProducto = () => {
    ...
    const addCarrito = ()=>{
        ...
        if(carritoData.filter(x=>x.CLAVEPRODUCTO === producto.CLAVE_P).length){
            ...
            fetch(`${import.meta.env.VITE_API}/insertarProductCarro/${userId}/${clavep}/${cantc}`, requestInit)
            .then(res => res.json())
            ...
            <div class='wrapperDp' key={producto.CLAVE_P}>
                <div class='wrapperI'>
                    <div class='image-wrapper'>
                        <img class='imgContent' src={`${import.meta.env.VITE_API}/products/`+ producto.CLAVE_P + '-IMG_PRINCIPAL.png'} alt="" />
                        <img class='imgContent' src={`${import.meta.env.VITE_API}/products/`+ producto.CLAVE_P + '-IMG1.png'} alt="" />
                        <img class='imgContent' src={`${import.meta.env.VITE_API}/products/`+ producto.CLAVE_P + '-IMG2.png'} alt="" />
                        <img class='imgContent' src={`${import.meta.env.VITE_API}/products/`+ producto.CLAVE_P + '-IMG3.png'} alt="" />
                    </div>
